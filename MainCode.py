...
def main():
    ...
    if choice == menu[1]:
        ...
        st.write("<h6 style='text-align: justify; color: Blue Jay;'>The app computes the cost rate for a specific solution—defined by inspection intervals (Δ), inspector assignments (Y), and the age-based threshold (T). It is crucial that Δ and Y have the same number of elements and that T is greater than or equal to the last inspection moment, otherwise, non-compliance errors will be reported.</h6>", unsafe_allow_html=True)
