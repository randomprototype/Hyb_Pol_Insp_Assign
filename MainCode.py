...
def main():
    ...
    if choice == menu[0]:
        ...
        Alpha=st.text_input("Insert the false-positive values of the inspectors ($\\alpha$)", value = "0.1 0.05")
        Beta=st.text_input("Insert the false-negative values of the inspectors ($\\beta$)", value = "0.1 0.05")
