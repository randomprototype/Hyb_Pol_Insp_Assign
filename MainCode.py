...
def main():
    ...
    if choice == menu[0]:
        ...
        Eta1=st.number_input("Insert the characteristic life of the weak component (η\u2081)", min_value = 0.0, value = 3.0, help="")
        ...
        for i, col in enumerate(st.columns(K)):
            ...
            Delta.append(col.number_input("Insp. Mom. (Δ)", min_value=0.0, value=2.0, key=f"Delta_{i}"))
